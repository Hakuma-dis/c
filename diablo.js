...
│BOT VERSION : V5
│OWNER NAME : Xez
│OWNER NUMBER : 6285740392651
│CREATOR SCRIPT : Aldous Ft Van
╰─────────────
╭─────WAR MENU────────
│bugmenu
...
┃⌦ virtekbiasa  
╰-----------------------------  
subscribe my youtube channel https://youtube.com/@VanMaker02
...
case 'verify':
 if (!isGroup) return diablobotwhatsapp.reply(`wajib dalam grup`)
if (!isGroupAdmins) return diablobotwhatsapp.reply(`*LU JANGAN SOK ASIK*`)
